...
\cvdoubleitem{Monitoring}{ELK, Prometheus, Grafana, \newline{}InfluxDB, Ganglia, Monit}{CI/CD}{Jenkins, TravisCI, Concourse, PHPUnit, Cucumber, Chai}
\cvdoubleitem{Programming Languages}{Python, PHP, Scala, Node.js, Ruby, Go}{Version Control}{Git, Github, Gitlab, Mercurial, SVN}
\cvitem{Service Configuration}{\textit{Databases:} MySQL, MongoDB, PostgreSQL, Oracle; \textit{Webservers:} Apache, nginx; \textit{Proxies:} HAProxy, pound, ELB; \textit{Message Queues:} Redis, ZeroMQ, Kafka, SQS}
\cvitem{Networking}{TCP/IP stack, routing, OpenVPN, iptables, ufw, VPC Peering}
\cvitem{ELK Stack}{Elasticsearch, Logstash, Kibana, Filebeat, Metricbeat, Packetbeat, Elastalert}
